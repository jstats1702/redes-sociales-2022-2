...
par(mfrow = c(1,2))
set.seed(42)
plot(karate, layout = layout_with_kk(karate), vertex.size = 14, vertex.frame.color = "black", vertex.label.color = "black", main = "Zachary")
plot(karate, layout = layout_with_fr(karate), vertex.size = 14, vertex.frame.color = "black", vertex.label.color = "black", main = "Zachary")
par(mfrow = c(1,1))
